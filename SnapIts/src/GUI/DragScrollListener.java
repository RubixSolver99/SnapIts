...
public class DragScrollListener implements MouseListener, MouseMotionListener {
	...
	private static final int DRAGABLE_HORIZONTAL_SCROLL_BAR = 0;

	private static final int DRAGABLE_VERTICAL_SCROLL_BAR = 0;
	...
	/**
	 * 
	 * Sets the scrolling intensity - the default value being 5. Note, that this has
	 * an
	 * 
